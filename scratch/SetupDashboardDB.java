    ...
    public static void main(String[] args) {
        try (Connection conn = DriverManager.getConnection(URL, USER, PASSWORD);
            ...
            stmt.execute("/******************************************************************************************************************************************************* \n" +
                         ...
                         "        '+12.5% vs mes anterior' AS ingresosCambio,\n" +
                         "        @gastosMes AS gastosMes,\n" +
                         "        '-8.3% vs mes anterior' AS gastosCambio,\n" +
                         "        @ahorrosMes AS ahorrosMes,\n" +
                         "        '+15.0% vs mes anterior' AS ahorrosCambio,\n" +
                         "        @balanceMes AS balanceMes,\n" +
                         "        '+24.1% vs mes anterior' AS balanceCambio,\n" +
                         ...
                         "        '¡Vas por buen camino!' AS bannerTitle,\n" +
                         "        'Has ahorrado 15% más que el mes pasado.' AS bannerDesc;\n" +
                         "END;");
