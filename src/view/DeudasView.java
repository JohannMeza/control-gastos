...
public class DeudasView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlCardDeudaTotal.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(234, 234, 241), 1, true));
        pnlCardDeudaTotal.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblCardDeudaTotalTitle.setFont(new java.awt.Font("Dialog", 1, 11)); // NOI18N
        ...
        lblCardDeudaTotalValue.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        ...
        jLabel14.setMinimumSize(new java.awt.Dimension(9, 9));
        jLabel14.setPreferredSize(new java.awt.Dimension(9, 9));
        jLabel14.setRequestFocusEnabled(false);
        jPanel16.add(jLabel14, "card2");

        pnlCardDeudaTotal.add(jPanel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, -1, -1));

        jPanelTabDeudas.add(pnlCardDeudaTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 310, 90));

        pnlCardProximoVencimiento.setBackground(new java.awt.Color(255, 255, 255));
        pnlCardProximoVencimiento.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(234, 234, 241), 1, true));
        pnlCardProximoVencimiento.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblCardProximoVencimientoTitle.setFont(new java.awt.Font("Dialog", 1, 11)); // NOI18N
        ...
        lblCardProximoVencimientoValue.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        ...
        jLabel15.setMinimumSize(new java.awt.Dimension(9, 9));
        jLabel15.setPreferredSize(new java.awt.Dimension(9, 9));
        jLabel15.setRequestFocusEnabled(false);
        jPanel17.add(jLabel15, "card2");

        pnlCardProximoVencimiento.add(jPanel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, -1, -1));

        jPanelTabDeudas.add(pnlCardProximoVencimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 10, 310, 90));

        pnlCardTotalPagado.setBackground(new java.awt.Color(255, 255, 255));
        pnlCardTotalPagado.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(234, 234, 241), 1, true));
        pnlCardTotalPagado.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblCardTotalPagadoTitle.setFont(new java.awt.Font("Dialog", 1, 11)); // NOI18N
        ...
        lblCardTotalPagadoValue.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        ...
        jPanel18.setBackground(new java.awt.Color(108, 248, 187));
        ...
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icon/green/controlar.png"))); // NOI18N
        jLabel16.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jLabel16.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jLabel16.setMaximumSize(new java.awt.Dimension(9, 9));
        jLabel16.setMinimumSize(new java.awt.Dimension(9, 9));
        jLabel16.setPreferredSize(new java.awt.Dimension(9, 9));
        jLabel16.setRequestFocusEnabled(false);
        jPanel18.add(jLabel16, "card2");

        pnlCardTotalPagado.add(jPanel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, -1, -1));

        jPanelTabDeudas.add(pnlCardTotalPagado, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 10, 320, 90));

        pnlNuevaDeuda.setBackground(new java.awt.Color(255, 255, 255));
        pnlNuevaDeuda.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(234, 234, 241), 1, true));
        pnlNuevaDeuda.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblNuevaDeudaTitle.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        ...
        txtAcreedor.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(226, 226, 226), 1, true));
        ...
        txtMontoTotal.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(226, 226, 226), 1, true));
        ...
        txtTasaInteres.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(226, 226, 226), 1, true));
        ...
        txtCuotasTotales.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(226, 226, 226), 1, true));
        ...
        btnRegistrarDeuda.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        ...
        jPanelTabDeudas.add(pnlNuevaDeuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 310, 260));

        pnlRegistrarAbono.setBackground(new java.awt.Color(255, 255, 255));
        pnlRegistrarAbono.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(234, 234, 241), 1, true));
        pnlRegistrarAbono.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblRegistrarAbonoTitle.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        ...
        txtMontoAbono.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(226, 226, 226), 1, true));
        ...
        btnConfirmarPago.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        btnConfirmarPago.setForeground(new java.awt.Color(37, 99, 235));
        btnConfirmarPago.setText("Confirmar Pago");
        btnConfirmarPago.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 1, true));
        ...
        jPanelTabDeudas.add(pnlRegistrarAbono, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 376, 310, 230));

        pnlDeudasActivas.setBackground(new java.awt.Color(255, 255, 255));
        pnlDeudasActivas.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(234, 234, 241), 1, true));
        pnlDeudasActivas.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblDeudasActivasTitle.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        ...
        pnlDebt1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(234, 234, 241), 1, true));
        pnlDebt1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblDebt1Title.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        ...
        lblDebt1Desc.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        ...
        lblDebt1ProgressText.setFont(new java.awt.Font("Dialog", 0, 9)); // NOI18N
        ...
        lblDebt1Percent.setFont(new java.awt.Font("Dialog", 1, 9)); // NOI18N
        ...
        lblDebt1SaldoTitle.setFont(new java.awt.Font("Dialog", 0, 9)); // NOI18N
        ...
        lblDebt1SaldoValue.setFont(new java.awt.Font("Dialog", 1, 13)); // NOI18N
        ...
        pnlDeudasActivas.add(pnlDebt1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 630, 68));

        pnlDebt3.setBackground(new java.awt.Color(255, 255, 255));
        pnlDebt3.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(234, 234, 241), 1, true));
        pnlDebt3.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblDebt3Title.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        ...
        lblDebt3Desc.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        ...
        lblDebt3ProgressText.setFont(new java.awt.Font("Dialog", 0, 9)); // NOI18N
        ...
        lblDebt3Percent.setFont(new java.awt.Font("Dialog", 1, 9)); // NOI18N
        ...
        lblDebt3SaldoTitle.setFont(new java.awt.Font("Dialog", 0, 9)); // NOI18N
        ...
        lblDebt3SaldoValue.setFont(new java.awt.Font("Dialog", 1, 13)); // NOI18N
        ...
        pnlDeudasActivas.add(pnlDebt3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, 630, 68));

        pnlDebt2.setBackground(new java.awt.Color(255, 255, 255));
        pnlDebt2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblDebt2Title.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        ...
        lblDebt2Desc.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        ...
        lblDebt2WarningIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icon/red/chat-flecha-abajo.png"))); // NOI18N
        pnlDebt2.add(lblDebt2WarningIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 42, 16, 16));

        lblDebt2WarningText.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        ...
        lblDebt2PayNow.setFont(new java.awt.Font("Dialog", 1, 11)); // NOI18N
        lblDebt2PayNow.setForeground(new java.awt.Color(37, 99, 235));
        lblDebt2PayNow.setText("Pagar ahora");
        pnlDebt2.add(lblDebt2PayNow, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 30, -1, -1));

        pnlDeudasActivas.add(pnlDebt2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 630, 68));

        jPanelTabDeudas.add(pnlDeudasActivas, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 110, 650, 265));

        pnlHistorialReciente.setBackground(new java.awt.Color(255, 255, 255));
        pnlHistorialReciente.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(234, 234, 241), 1, true));
        pnlHistorialReciente.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblHistorialRecienteTitle.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        ...
        lblExportarCSV.setFont(new java.awt.Font("Dialog", 1, 11)); // NOI18N
        ...
        tblHistorial.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "FECHA", "DEUDA", "MONTO PAGADO", "SALDO RESTANTE"
            }
        ) {
        ...
        jPanelTabDeudas.add(pnlHistorialReciente, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 380, 650, 215));
