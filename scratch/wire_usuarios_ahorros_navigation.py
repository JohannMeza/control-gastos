...
java_path = r"d:\Estudios\Superiores\Universidad UTP\Ciclo 7\Algoritmos y Estructura de Datos\Semana 5\ControlGastos\src\view\UsuariosView.java"
form_path = r"d:\Estudios\Superiores\Universidad UTP\Ciclo 7\Algoritmos y Estructura de Datos\Semana 5\ControlGastos\src\view\UsuariosView.form"

# 1. Update UsuariosView.form (XML)
if os.path.exists(form_path):
    ...
    if target is not None:
        ...
        print("UsuariosView.form updated with Ahorros click navigation.")
    else:
        print("Error: jPanelEmployes not found in UsuariosView.form")
else:
    print("Error: UsuariosView.form not found.")

# 2. Update UsuariosView.java
if os.path.exists(java_path):
    ...
    if re.search(registration_pattern, content):
        print("Java registration already exists in UsuariosView for jPanelEmployes")
    else:
        ...
        if bg_match:
            ...
            with open(java_path, "w", encoding="utf-8") as f:
                f.write(content)
            print("UsuariosView.java updated with mouse listener registration for jPanelEmployes.")
        else:
            print("Error: setBackground call for jPanelEmployes not found in UsuariosView.java")
else:
    print("Error: UsuariosView.java not found.")
